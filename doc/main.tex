...
The file \code{bloom/bloom.py} contains a skeleton implementation of a Bloom filter class, as well as a small script to test it on words from \code{example_text.txt} and \code{random_strings.txt}.
%
\begin{mybox}{Exercises}
    \begin{enumerate}
